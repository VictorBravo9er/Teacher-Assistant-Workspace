...
- [`AGENTS.md`](file:///home/victor/antigravity/Teacher-Assistant-Workspace/AGENTS.md): The root governing rules, cascading guidelines, engineering principles (SRP, DRY, type safety), security and environment standards, ephemeral scratch directory (`./.scratch/`) guidelines, and documentation requirements for the workspace.

...
export const DEFAULT_TEMPLATES: Template[] = [
  {
    ...
    description:
      "A comprehensive preset optimized for high-school math, with focus on problem-solving, formula retention, and active tracking.",
    subject: "Mathematics",
    ...
    instructions: [
      {
        ...
        type: "criteria",
        content:
          "Identify operational errors versus structural concept errors. Provide positive reinforcement of the formula setup before drilling down into arithmetic calculations.",
      },
      {
        title: "Socratic Prompting Guide",
        type: "preference",
        content:
          'Never give the final answer directly in the feedback. Ask leading questions about the next logical step (e.g., \"What should we do to both sides to isolate the variable?\").',
      },
    ],
    materialsPreset: [
      {
  ...
  },
  {
    ...
    description:
      "Designed for STEM laboratory environments, offering specific marking criteria for experimental setups, observations, and error analyses.",
    subject: "Physics",
    ...
    instructions: [
      {
        ...
        type: "criteria",
        content:
          "Look closely at student explanations of human vs. systematic error. Ensure they distinguish between precision issues and calibration offsets.",
      },
    ],
    materialsPreset: [
      {
  ...
  },
  {
    ...
    description:
      "Generic rubric for assessments, testing conceptual depth, logic sequencing, and presentation accuracy.",
    ...
    instructions: [
      {
        ...
        type: "marking",
        content:
          "Award up to 40% credit for writing the correct formula, 30% for showing systematic algebraic resolution, and 30% for final answer precision.",
      },
    ],
    materialsPreset: [],
  },
  {
    ...
    description:
      "A blank canvas with standard field presets tailored for creative storytelling-style instruction across humanistic-scientific topics.",
    ...
    instructions: [
      {
        ...
        type: "preference",
        content:
          "Map scientific concepts to everyday items (e.g., using water pipes to explain cell wall permeability or electrical flow).",
      },
    ],
    materialsPreset: [],
  },
...
export const DEFAULT_WORKSPACES: ClassModel[] = [
  {
    ...
    specialNotes:
      "Focusing heavily on bridging basic algebraic reasoning before diving into complex coordinate geometry this semester.",
    assessmentPreferences:
      "Bi-weekly diagnostic quizzes, extensive written homework folders, final project portfolios.",
    materials: [
      {
        id: "mat-1",
        ...
        versionHistory: [
          {
            version: "v1.1",
            date: "2026-03-10",
            note: "Added high-res diagram appendix",
          },
        ],
      },
      {
        ...
        versionHistory: [
          {
            version: "v1.0",
            date: "2026-05-18",
            note: "Finalized coefficients guidelines",
          },
        ],
      },
    ],
    ...
    students: [
      {
        ...
        parentNotes:
          "Extremely supportive. Prefers weekly email alerts. Aarav wants to study robotics in college.",
        grades: [
          {
            id: "g-1",
            assessmentName: "Algebra Quiz 1",
            score: 98,
            maxScore: 100,
            date: "2026-03-01",
            feedback: "Stellar work! Brilliant operational precision.",
          },
          {
            id: "g-2",
            assessmentName: "Polynomials Test",
            score: 95,
            maxScore: 100,
            date: "2026-04-10",
            feedback: "Minor sign error in question 4, but excellent work.",
          },
          {
            id: "g-3",
            assessmentName: "Geometry Midterm",
            score: 92,
            maxScore: 100,
            date: "2026-05-20",
            feedback: "Solid theorem proofs.",
          },
        ],
        attendance: 98,
        ...
        uploads: [
          {
            id: "up-1",
            name: "Aarav_AlgebraQuiz1_Answers.pdf",
          ...
          {
            id: "up-2",
            name: "Aarav_Midterm_Written.pdf",
        ...
        customFields: [
          ...
          },
          {
            ...
            type: "text",
            value: "Nominated for regional math olympiad.",
            visibility: true,
          },
        ],
      },
      {
        ...
        parentNotes:
          "Sofia is highly artistic. Struggles with math anxiety which occasionally impacts test scores.",
        grades: [
          {
            id: "g-4",
            assessmentName: "Algebra Quiz 1",
            ...
            maxScore: 100,
            date: "2026-03-01",
            feedback: "Concept is there, but minor equation balance issues.",
          },
          {
            id: "g-5",
            assessmentName: "Polynomials Test",
            ...
            date: "2026-04-10",
            feedback:
              "Severe learning gap identified in factoring polynomials. Let's schedule clinic.",
          },
          {
            id: "g-6",
            assessmentName: "Geometry Midterm",
            ...
            maxScore: 100,
            date: "2026-05-20",
            feedback: "Struggled with multi-stage coordinate geometry proofs.",
          },
        ],
        attendance: 78,
        ...
        uploads: [
          {
            id: "up-3",
            name: "Sofia_AlgebraQuiz1_Final.pdf",
            type: "Quiz Submission",
            date: "2026-03-01",
            status: "graded",
          },
          {
            id: "up-4",
            name: "Sofia_Polynomials_Revised.docx",
            type: "Homework Remedial",
            date: "2026-04-20",
            status: "graded",
          },
          {
            id: "up-5",
            name: "Sofia_GeometryMidterm_Answers.pdf",
            type: "Exam Submission",
            date: "2026-05-20",
            status: "pending",
          },
        ...
        customFields: [
          ...
          },
          {
            ...
            type: "text",
            value:
              "Arranged extra examination time (1.5x) due to anxiety accommodations.",
            visibility: true,
          },
        ],
      },
      {
        ...
        parentNotes:
          "Very communicative. Ethan is quite active in athletic programs.",
        grades: [
          {
            id: "g-7",
            assessmentName: "Algebra Quiz 1",
          ...
          },
          {
            ...
            maxScore: 100,
            date: "2026-05-20",
            feedback: "Good conceptual clarity in geometric proof structures.",
          },
        ],
        attendance: 92,
      ...
      },
      {
        ...
        parentNotes:
          "Speaks Mandarin at home. Highly disciplined. Strives for excellence.",
        grades: [
          {
            id: "g-10",
            assessmentName: "Algebra Quiz 1",
      ...
      },
      {
        ...
        parentNotes:
          "Bilingual. Outstanding reader. Quick to catch visual geometry concepts.",
        grades: [
          {
            id: "g-13",
            assessmentName: "Algebra Quiz 1",
          ...
          },
          {
            ...
            maxScore: 100,
            date: "2026-05-20",
            feedback: "Superb proofs! Perfect drawing integration.",
          },
        ],
        attendance: 91,
        performanceIndicator: "good",
...
- **Mock Rubric Integration**: Let Sofia use the visual Socratic prompts.`,
            ...
            visualization: {
              ...
              description:
                "Clear score divide showing students needing attention under 70%",
              data: [
                {
                  name: "Aarav Sharma",
                  score: 92,
...
This shifts the focus from \"correct answers\" to \"secure processes\".`,
  ...
  },
  {
    ...
    experienceLevel: "Senior Instructor (12 Years)",
    specialNotes:
      "Focusing heavily on empirical setups, lab data collection precision, and experimental bias descriptions.",
    materials: [
      {
        id: "mat-4",
    ...
    instructions: [
      {
        ...
        type: "criteria",
        content:
          "Check for empirical numbers, unit declarations (e.g. m/s^2), and correct identification of independent/dependent variables.",
      },
    ],
    students: [
      {
        ...
        parentNotes:
          "Lucas prefers practical labs over formula exams. Highly visual.",
        grades: [
          {
            id: "g-16",
            assessmentName: "Lab 1 - Free Fall",
            score: 95,
            maxScore: 100,
            date: "2026-02-28",
          },
          {
            id: "g-17",
            assessmentName: "Kinematics exam",
            score: 78,
            maxScore: 100,
            date: "2026-04-05",
          },
        ...
        uploads: [
          {
            id: "up-9",
            name: "Lucas_Lab1Report_Final.docx",
            type: "Lab Report",
            date: "2026-02-27",
            status: "graded",
          },

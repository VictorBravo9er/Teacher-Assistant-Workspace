...
- [`StudentRegister.tsx`](file:///home/victor/antigravity/Teacher-Assistant-Workspace/frontend/src/features/students/StudentRegister.tsx): The student roster view displaying enrolled students in responsive cards with attendance percentages, current grades, performance indicators, non-blocking optimistic enrollment with loading animation overlays, and modal triggers.

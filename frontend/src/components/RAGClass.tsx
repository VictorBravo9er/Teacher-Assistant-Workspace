            ...
            activeSession.messages.map((msg) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`space-y-3.5 max-w-[85%] ${isAssistant ? "" : "flex flex-col items-end"}`}
                  >
                    {/* Chat Text Bubble */}
                    <div
              ...
              <div className="space-y-2.5 max-w-[70%]">
                <div className="bg-surface border border-border-color rounded-2xl p-4 flex flex-col gap-2 w-72">
                  <span className="text-[10px] font-mono text-primary">
                    AI Thinking & Grading Submissions...
                  </span>
        ...
        {sessions.length > 0 &&
          ...
          !isGeneratingAI && (
            <div className="px-6 py-2 shrink-0 flex items-center gap-2 overflow-x-auto scrollbar-none z-20">
              <span className="text-[9px] font-mono text-muted-text font-bold shrink-0">
                Quick Gaps:
              </span>
        ...
        <div className="fixed inset-0 bg-primary-text/40 backdrop-blur-md flex items-center justify-center p-4 z-50 animate-fade-in">
          <div className="bg-surface border border-border-color rounded-3xl max-w-xl w-full p-6 space-y-4 shadow-2xl relative">
            ...
            <div className="flex items-center gap-2 pb-2.5 border-b border-border-color">
              ...
              <div>
                ...
                <span className="text-[10px] font-mono text-muted-text">
                  Retrieval Augmented Generation ClassModel
                </span>
              </div>
            </div>
            ...
            <form onSubmit={handleCreateNewSession} className="space-y-4">
              {/* Type Grid */}
              <div>
                <label className="text-[10px] font-mono text-muted-text uppercase tracking-wider block mb-1.5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-[10px] font-mono text-muted-text uppercase block mb-1.5">
                    Focus Scope Bounds
                  </label>
                  <select
                    value={analysisScope}
                ...
                <div>
                  <label className="text-[10px] font-mono text-muted-text uppercase block mb-1.5">
                    Select specific bounds
                  </label>
                  {analysisScope === "class" ? (
                    <div className="text-[11px] font-mono py-2 text-primary leading-normal">
                      Full class of {classItem.students.length} students
                      indexed.
                    </div>
                  ) : (
                    <div className="max-h-20 overflow-y-auto border border-border-color rounded-lg p-1.5 bg-surface space-y-1">
                      {analysisScope === "students" &&
                        classItem.students.map((s) => (
                          <label
                            key={s.id}
                            className="flex items-center gap-1.5 text-xs text-primary-text"
                          >
                            <input
                              type="checkbox"
              ...
              <div>
                <label className="text-[10px] font-mono text-muted-text block mb-1">
                  OPTIONAL BRIEFING INSTRUCTIONS
                </label>
                <textarea
